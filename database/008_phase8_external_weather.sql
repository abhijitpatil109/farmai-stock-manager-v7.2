...
ALTER TABLE weather_locations ADD COLUMN IF NOT EXISTS location_reference_type text;
ALTER TABLE weather_locations ADD COLUMN IF NOT EXISTS location_reference text;
